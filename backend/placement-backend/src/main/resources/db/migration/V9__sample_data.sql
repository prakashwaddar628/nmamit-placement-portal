...
INSERT IGNORE INTO users (college_email, password, role, is_active, created_at, updated_at) VALUES
...
-- Student Profiles
INSERT IGNORE INTO student_profile (user_id, usn, full_name, mobile, alternate_email, date_of_birth, gender, department, branch, current_semester, cgpa, active_backlogs, city, state, country, pincode, created_at, updated_at) VALUES
...
-- Companies
INSERT IGNORE INTO company (company_name, website, industry, description, logo_url, active, created_at, updated_at) VALUES
...
-- Job Drives
INSERT IGNORE INTO job_drive (company_id, job_role, job_type, package_lpa, location, drive_date, registration_deadline, minimum_cgpa, allowed_backlogs, description, status, created_at, updated_at) VALUES
...
INSERT IGNORE INTO job_drive_eligible_branch (job_drive_id, branch) VALUES
...
-- Applications
INSERT IGNORE INTO application (student_profile_id, job_drive_id, status, applied_at, updated_at) VALUES
